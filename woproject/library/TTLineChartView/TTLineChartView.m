...
- (void)setupAxleX
{
    ...
    for (int i = 0; i < self.elementData.count; i++) {
        ...
        view.backgroundColor = [UIColor colorWithRed:51 / 255.0 green:61 / 255.0 blue:51 / 255.0 alpha:1];
...
- (void)setupAlexY
{
    ...
    for (int i = 0; i < 4; i++) {
        ...
        label.font = Font(12);
        label.textColor = RGBCOLOR(51, 61, 51);
        [label sizeToFit];
...
- (void)setupBackgroundLayer
{
    ...
    CGColorRef color1 = RGBCOLOR(240, 240 , 240).CGColor;
    CGColorRef color2 = RGBCOLOR(240, 240, 240).CGColor;
...
- (void)setupGradientLayer
{
    ...
    CGColorRef color1 = RGBCOLOR(230, 230, 230).CGColor;
    CGColorRef color2 = RGBCOLOR(230, 230, 230).CGColor;
...
- (void)selectIndex:(NSInteger)index
{
    ...
    if (self.historyData.count > index) {
        ...
        NSMutableAttributedString *valueString = [[NSMutableAttributedString alloc] initWithString:history.detailX attributes:@{NSForegroundColorAttributeName: RGBCOLOR(39, 197, 179),NSFontAttributeName: Font(15)}];
